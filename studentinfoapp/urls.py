"""studentinfoapp URL Configuration
...
urlpatterns = [
	...
	#classes are referenced differently, no views.py function needed:
    path('login/', LoginView.as_view(template_name='stinfo/login.html'), name = 'login'),
